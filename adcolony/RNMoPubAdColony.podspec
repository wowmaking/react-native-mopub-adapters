...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                  MoPub SDK AdColony adapter for React Native
                   DESC
  s.homepage     = "https://github.com/github_account/react-native-rn-mo-pub-adcolony"
  s.license      = "MIT"
  s.authors      = { "Gleb Volchetskiy" => "g.volchetskiy@wannaplay.gg" }
  s.platforms    = { :ios => "9.0" }
  s.source       = { :git => "https://github.com/github_account/react-native-rn-mo-pub-adcolony.git", :tag => "#{s.version}" }
